package com.example.jizhaowatchvideo;
...
import com.example.jizhaowatchvideo.Models.MediaObject;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    //how much of that viewholder is in view
    //give preference to the top one
    private int videoSurfaceDefaultHeight = 0;
    private int screenDefaultHeight = 0;
    private Context context;
    private int playPosition = -1; //the currently playing
        ...
        addOnChildAttachStateChangeListener(new OnChildAttachStateChangeListener() {
            ...
            public void onChildViewDetachedFromWindow(View view) {
                if (viewHolderParent != null && viewHolderParent.equals(view)) {
                    //if scroll up, remove the playing video from the screen
                    resetVideoView();
                }
    ...
    //decide which video gonna be played, base on its position on the screen and how much of the video view will be showing
    ...
    //reset everything, and get ready for next video
    ...
    //video will continue play unless it released
