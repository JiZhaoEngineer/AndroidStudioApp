...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Denver civic center
        LatLng civic_center = new LatLng(39.736640, -104.989612);

        mMap.addMarker(new MarkerOptions().position(civic_center).title("Marker in civic center at Denver"));
        ...
        mMap.getUiSettings().setMapToolbarEnabled(true);    // open google maps

        Log.i("info", "max zoom："+mMap.getMaxZoomLevel());
        Log.i("info", "min zoom："+mMap.getMinZoomLevel());

        mMap.moveCamera(CameraUpdateFactory.newLatLng(civic_center));
        mMap.animateCamera(CameraUpdateFactory.zoomTo(16));     // zoom to 16x more
